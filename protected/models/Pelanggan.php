...
class Pelanggan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idDivisi, level, status, debit, kredit, jenisKelamin', 'numerical', 'integerOnly'=>true),
			...
			array('idAnggota, namaLengkap, jenisKelamin, tanggalLahir, alamat, email, telephone, idDivisi, username, password, level, status', 'safe', 'on'=>'search'),
			);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'email' => 'Email',
			'telephone' => 'Telephone',
			'idDivisi' => 'Klasifikasi',
			'username' => 'Username',
			'password' => 'Password',
			'level' => 'Level',
			'status' => 'Status',
			'debit' => 'Total Simpanan',
			'credit' => 'Total Pinjaman',
			);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idAnggota',$this->idAnggota);
	...
	{
		$sql = "SELECT COUNT(idAnggota) as totalMember FROM User";
