...
$this->pageTitle='Faktur Pembelian #'.$model->id;
?>
...
<div class="row" id="page"  onclick="cetak()">
	<div class="col-md-12">
		<div class="panel panel-default card-view">
			...
			">
			<div class="pull-left">
				<h6 class="panel-title txt-dark"><b>Faktur Pembelian: #<?php echo $model->id; ?></b> <span class="hidden-xs">- <?php echo YII::app()->name; ?></span></h6>
			</div>
			<div class="pull-right">
				<img class="brand-img pull-left img-responsive" src="<?php echo YII::app()->baseUrl."/image/shop/".Shop::model()->logo(); ?>" alt="Logo" style="
				margin: 5px 0px;
				"/>
			</div>
					...
					<div class="col-xs-6">
						...
						<address class="mb-15">
							<span class="address-head mb-5">
								<b><?php echo $model->Supplier->nama; ?></b></span> <br>
								<?php echo $model->Supplier->alamat; ?> <br>
								<?php echo $model->Supplier->telepon; ?>
							</address>
						</div>
						...
						<div class="row">
							<div class="col-xs-12 text-right">
								<address>
									...
									<b><?php echo $model->tanggal_masuk; ?></b>
								</address>
							</div>
						</div>
