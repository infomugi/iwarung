...
class UserController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions'=>array('view','update','editpassword'),
				'users'=>array('@'),
				'expression'=>'Yii::app()->user->record->level==2',
				),
			array('allow',
				'actions'=>array('create','update','view','delete','admin','index','setadmin','setowner','setemployee','setuser'),
				'users'=>array('@'),
	...
	public function actionSetEmployee($id)
	{
		$model=$this->loadModel($id);
		$model->level = 3;
		$model->status = 1;
