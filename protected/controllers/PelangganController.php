...
class PelangganController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow',
				'actions'=>array('update','view','create','index','admin'),
				'users'=>array('@'),
				'expression'=>'Yii::app()->user->record->level==2',
				),			
			array('allow',
				'actions'=>array('create','update','view','delete','admin','index','enable'),
				'users'=>array('@'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Pelanggan']))
		{
			...
			$model->level = 2 ;
			if($model->save())
				$this->redirect(array('view','id'=>$model->idAnggota));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Pelanggan',array('criteria'=>array('condition'=>'status=1')));
